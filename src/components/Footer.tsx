      ...
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 md:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-sm mt-2">
              The AI-powered e-learning platform for the modern learner. Discover courses, expand your knowledge, and grow your skills with personalized learning.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/categories" className="text-gray-600 hover:text-brand-600">
                  Categories
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/for-instructors" className="text-gray-600 hover:text-brand-600">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/community" className="text-gray-600 hover:text-brand-600">
                  Learning Community
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/cookie-policy" className="text-gray-600 hover:text-brand-600">
                  Cookie Policy
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-10 pt-6 border-t border-gray-200">
          <p className="text-xs text-gray-500">
            &copy; {new Date().getFullYear()} LearnWise AI. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
